...
_BUILTIN: list[InteractionStyle] = [
    ...
    InteractionStyle(
        ...
        voice="",
        lines={
            "tap": ("我在我在！今天也一起加油呀。", "嘿嘿，点到我啦。", "要不要先给自己一点小奖励？"),
    ...
    InteractionStyle(
        ...
        lines={
            ...
            "happy": ("任务完成。不错，这次处理得很利落。", "收尾得很好，可以进入下一步了。", "很好，结果已经稳住了。"),
    ...
    InteractionStyle(
        ...
        voice="",
        lines={
            "tap": ("哼，才不是特意等你点的。", "别误会，我只是刚好在。", "……看在你这么努力的份上，陪你一下。"),
            "happy": ("哼，还算顺利吧，我可没特意等你完成。", "完成了？还不错嘛。", "勉强算你这次处理得漂亮。"),
